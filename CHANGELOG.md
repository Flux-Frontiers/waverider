...
- **`README.md`** — documents the holographic output paths in the viz-extras section (quilt and HLD example commands) and lists the new modules and docs in the file tree.
